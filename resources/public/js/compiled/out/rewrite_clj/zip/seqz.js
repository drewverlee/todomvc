...
var G__31346 = f.call(null,n0);
var G__31346__$1 = (((G__31346 == null))?null:cljs.core.iterate.call(null,((function (G__31346,n0,temp__4655__auto__){
return (function (loc){
...
});})(G__31346,n0,temp__4655__auto__))
,G__31346));
var G__31346__$2 = (((G__31346__$1 == null))?null:cljs.core.take_while.call(null,cljs.core.identity,G__31346__$1));
var G__31346__$3 = (((G__31346__$2 == null))?null:cljs.core.last.call(null,G__31346__$2));
if((G__31346__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up.call(null,G__31346__$3);
}
} else {
return zloc;
}
...
var G__31347 = rewrite_clj.zip.move.right.call(null,v);
var G__31348 = rewrite_clj.zip.move.up.call(null,v);
loc = G__31347;
parent = G__31348;
continue;
} else {
var G__31349 = rewrite_clj.zip.move.right.call(null,v0);
var G__31350 = parent;
loc = G__31349;
parent = G__31350;
continue;
...
var G__31351 = rewrite_clj.zip.move.right.call(null,rewrite_clj.zip.move.right.call(null,v));
var G__31352 = rewrite_clj.zip.move.up.call(null,v);
loc = G__31351;
parent = G__31352;
continue;
} else {
var G__31353 = rewrite_clj.zip.move.right.call(null,rewrite_clj.zip.move.right.call(null,loc));
var G__31354 = parent;
loc = G__31353;
parent = G__31354;
continue;
...
if(cljs.core.truth_(rewrite_clj.zip.seqz.map_QMARK_.call(null,zloc))){
var G__31355 = zloc;
var G__31355__$1 = (((G__31355 == null))?null:rewrite_clj.zip.move.down.call(null,G__31355));
var G__31355__$2 = (((G__31355__$1 == null))?null:rewrite_clj.zip.findz.find_value.call(null,G__31355__$1,k));
if((G__31355__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right.call(null,G__31355__$2);
}
} else {
return cljs.core.nth.call(null,(function (){var G__31356 = rewrite_clj.zip.move.down.call(null,zloc);
var G__31356__$1 = (((G__31356 == null))?null:cljs.core.iterate.call(null,rewrite_clj.zip.move.right,G__31356));
if((G__31356__$1 == null)){
return null;
} else {
return cljs.core.take_while.call(null,cljs.core.identity,G__31356__$1);
}
})(),k);
}
});
...
//# sourceMappingURL=seqz.js.map?rel=1530661644659
