...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__26012_SHARP_){
var _STAR_delimiter_STAR_26013 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = delimiter;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__26012_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR_26013;
}}));
});
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__26018){
var vec__26019 = p__26018;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__26019,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq26014){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26015,G__26016,G__26017,seq26014__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__26025 = rewrite_clj.reader.peek.call(null,reader);
switch (G__26025) {
case "(":
...
var G__26027 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
...
if(cljs.core._EQ_.call(null,"_",G__26027)){
...
//# sourceMappingURL=core.js.map?rel=1530661634457
