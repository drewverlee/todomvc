...
if((c === "\n")){
var G__26006 = escape_QMARK_;
var G__26007 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__26006;
lines = G__26007;
continue;
} else {
buf.append(c);

var G__26008 = ((!(escape_QMARK_)) && ((c === "\\")));
var G__26009 = lines;
escape_QMARK_ = G__26008;
lines = G__26009;
continue;
...
//# sourceMappingURL=string.js.map?rel=1530661634398
