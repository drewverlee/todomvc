...
rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4174__auto__,k25829,else__4175__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k25829,else__4175__auto__);
...
rewrite_clj.node.token.TokenNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__25828){
var self__ = this;
var G__25828__$1 = this;
return (new cljs.core.RecordIter((0),G__25828__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"string-value","string-value",1109600561)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this25830,other25831){
var self__ = this;
var this25830__$1 = this;
return ((!((other25831 == null))) && ((this25830__$1.constructor === other25831.constructor)) && (cljs.core._EQ_.call(null,this25830__$1.value,other25831.value)) && (cljs.core._EQ_.call(null,this25830__$1.string_value,other25831.string_value)) && (cljs.core._EQ_.call(null,this25830__$1.__extmap,other25831.__extmap)));
});
...
rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4179__auto__,k__4180__auto__,G__25828){
var self__ = this;
var this__4179__auto____$1 = this;
var pred__25834 = cljs.core.keyword_identical_QMARK_;
var expr__25835 = k__4180__auto__;
if(cljs.core.truth_(pred__25834.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__25835))){
return (new rewrite_clj.node.token.TokenNode(G__25828,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__25834.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__25835))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__25828,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4180__auto__,G__25828),null));
}
}
});
...
rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4171__auto__,G__25828){
var self__ = this;
var this__4171__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__25828,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__25832){
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__25832),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__25832),null,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,G__25832,new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"string-value","string-value",1109600561))),null));
});
...
//# sourceMappingURL=token.js.map?rel=1530661633571
