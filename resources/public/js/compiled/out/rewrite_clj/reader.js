...
/** @this {Function} */
rewrite_clj.reader.throw_reader.cljs$lang$applyTo = (function (seq25755){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25756,G__25757,seq25755__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(rewrite_clj.reader.read_until.call(null,reader,(function (p1__25764_SHARP_){
return (((p1__25764_SHARP_ == null)) || (rewrite_clj.reader.linebreak_QMARK_.call(null,p1__25764_SHARP_)));
...
var G__25765 = (cljs.core.truth_(p_QMARK_.call(null,v))?(c + (1)):c);
var G__25766 = cljs.core.conj.call(null,vs,v);
c = G__25765;
vs = G__25766;
continue;
} else {
...
return cljs.tools.reader.impl.errors.reader_error(reader,"Invalid token: ",token);
} else {
...
//# sourceMappingURL=reader.js.map?rel=1530661633270
