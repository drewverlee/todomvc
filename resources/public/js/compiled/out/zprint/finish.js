...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__31043_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__31043_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__31043_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__31044){
var vec__31045 = p__31044;
var low = cljs.core.nth.call(null,vec__31045,(0),null);
var high = cljs.core.nth.call(null,vec__31045,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__31048,s,color,element,idx){
...
var style_map = cljs.core.get.call(null,map__31049__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__31049__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__31049__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__31051){
var vec__31052 = p__31051;
var s = cljs.core.nth.call(null,vec__31052,(0),null);
var style = cljs.core.nth.call(null,vec__31052,(1),null);
var start = cljs.core.nth.call(null,vec__31052,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__31055){
var vec__31056 = p__31055;
var s = cljs.core.nth.call(null,vec__31056,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__31056,(1),null);
var element = cljs.core.nth.call(null,vec__31056,(2),null);
...
var G__31059 = cljs.core.next.call(null,ssv);
var G__31060 = (this_ssv == null);
var G__31061 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__31062 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && (!((this_ssv == null)))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__31059;
doing_nil_QMARK_ = G__31060;
last_elide = G__31061;
out = G__31062;
continue;
}
...
var vec__31063 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__31063,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__31063,(1),null);
var element_type = cljs.core.nth.call(null,vec__31063,(2),null);
...
var G__31066 = cljs.core.next.call(null,remaining_cvec);
var G__31067 = new_idx;
var G__31068 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__31066;
idx = G__31067;
out = G__31068;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__31079,cursor_vec){
var vec__31080 = p__31079;
var focus_start = cljs.core.nth.call(null,vec__31080,(0),null);
var focus_end = cljs.core.nth.call(null,vec__31080,(1),null);
var focus_vec = vec__31080;
...
var vec__31083 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__31083,(0),null);
var back = cljs.core.nth.call(null,vec__31083,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__31086){
var vec__31087 = p__31086;
var s = cljs.core.nth.call(null,vec__31087,(0),null);
var color = cljs.core.nth.call(null,vec__31087,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__31093,existing_count){
var vec__31094 = p__31093;
var s = cljs.core.nth.call(null,vec__31094,(0),null);
var cursor = cljs.core.nth.call(null,vec__31094,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__31094,s,cursor){
return (function (p1__31090_SHARP_){
return !(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__31090_SHARP_)));
});})(s__$1,len,cursor__$1,vec__31094,s,cursor))
...
var vec__31098 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__31098,(0),null);
var where = cljs.core.nth.call(null,vec__31098,(1),null);
var cvec_element = vec__31098;
if((cvec_element == null)){
var G__31101 = cljs.core.next.call(null,cvec_nl);
var G__31102 = (idx + (1));
var G__31103 = start;
var G__31104 = out;
cvec_nl = G__31101;
...
var G__31105 = cljs.core.next.call(null,cvec_nl);
var G__31106 = (idx + (1));
var G__31107 = idx;
var G__31108 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__31105;
idx = G__31106;
start = G__31107;
out = G__31108;
...
var G__31109 = cljs.core.next.call(null,cvec_nl);
var G__31110 = (idx + (1));
var G__31111 = (idx + (1));
var G__31112 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__31109;
idx = G__31110;
start = G__31111;
out = G__31112;
...
var G__31113 = cljs.core.next.call(null,cvec_nl);
var G__31114 = (idx + (1));
var G__31115 = idx;
var G__31116 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__31113;
idx = G__31114;
start = G__31115;
out = G__31116;
...
var G__31117 = cljs.core.next.call(null,cvec_nl);
var G__31118 = (idx + (1));
var G__31119 = start;
var G__31120 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__31117;
idx = G__31118;
start = G__31119;
out = G__31120;
...
return cljs.core.reduce.call(null,(function (p1__31122_SHARP_,p2__31121_SHARP_){
if(cljs.core.truth_(zprint.finish.within_QMARK_.call(null,idx,p2__31121_SHARP_))){
return cljs.core.reduced.call(null,p1__31122_SHARP_);
} else {
return (p1__31122_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__31123,p__31124){
var vec__31125 = p__31123;
var focus_begin = cljs.core.nth.call(null,vec__31125,(0),null);
var focus_end = cljs.core.nth.call(null,vec__31125,(1),null);
var vec__31128 = p__31124;
var before = cljs.core.nth.call(null,vec__31128,(0),null);
var after = cljs.core.nth.call(null,vec__31128,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__31132,cvec,focus_vec){
...
var options = map__31133__$1;
var map__31134 = cljs.core.get.call(null,map__31133__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.call(null,map__31134__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__31134__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__31134__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__31133,map__31133__$1,options,map__31134,map__31134__$1,focus,lines,paths){
return (function (p1__31131_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__31131_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__31133,map__31133__$1,options,map__31134,map__31134__$1,focus,lines,paths))
,path_vecs);
...
//# sourceMappingURL=finish.js.map?rel=1530661644025
