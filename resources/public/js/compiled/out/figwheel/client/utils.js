...
return (new CustomEvent(event_name,(function (){var obj37484 = {"detail":data};
return obj37484;
})()));
} else {
...
var f = (function (){var pred__37491 = cljs.core._EQ_;
var expr__37492 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37491.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37492))){
return ((function (pred__37491,expr__37492){
return (function (p1__37485_SHARP_){
return console.warn(p1__37485_SHARP_);
});
;})(pred__37491,expr__37492))
} else {
if(cljs.core.truth_(pred__37491.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37492))){
return ((function (pred__37491,expr__37492){
return (function (p1__37486_SHARP_){
return console.debug(p1__37486_SHARP_);
});
;})(pred__37491,expr__37492))
} else {
if(cljs.core.truth_(pred__37491.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37492))){
return ((function (pred__37491,expr__37492){
return (function (p1__37487_SHARP_){
return console.error(p1__37487_SHARP_);
});
;})(pred__37491,expr__37492))
} else {
return ((function (pred__37491,expr__37492){
return (function (p1__37488_SHARP_){
return console.log(p1__37488_SHARP_);
});
;})(pred__37491,expr__37492))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37495){
...
var eval_fn = cljs.core.get.call(null,map__37496__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37498_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37500,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1530661655994
