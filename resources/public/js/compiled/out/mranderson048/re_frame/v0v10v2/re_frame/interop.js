...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__29201 = cljs.core.instance_QMARK_;
var expr__29202 = reactive_val;
if(cljs.core.truth_(pred__29201.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.RAtom,expr__29202))){
return "ra";
} else {
if(cljs.core.truth_(pred__29201.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.RCursor,expr__29202))){
return "rc";
} else {
if(cljs.core.truth_(pred__29201.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.Reaction,expr__29202))){
return "rx";
} else {
if(cljs.core.truth_(pred__29201.call(null,mranderson048.reagent.v0v7v0.reagent.ratom.Track,expr__29202))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1530661639997
