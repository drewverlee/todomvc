...
var G__29053 = o;
(G__29053[mranderson048.reagent.v0v7v0.reagent.impl.template.cached_prop_name.call(null,k)] = mranderson048.reagent.v0v7v0.reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__29055__i < G__29055__a.length) {G__29055__a[G__29055__i] = arguments[G__29055__i + 0]; ++G__29055__i;}
  args = new cljs.core.IndexedSeq(G__29055__a,0,null);
} 
...
var G__29059 = jsprops;
(G__29059["defaultValue"] = value);

(G__29059["onChange"] = ((function (G__29059,v,value,on_change){
return (function (p1__29058_SHARP_){
return mranderson048.reagent.v0v7v0.reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__29058_SHARP_);
});})(G__29059,v,value,on_change))
);
...
var vec__29062 = cljs.core.next.call(null,cljs.core.re_matches.call(null,mranderson048.reagent.v0v7v0.reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__29062,(0),null);
var id = cljs.core.nth.call(null,vec__29062,(1),null);
var class$ = cljs.core.nth.call(null,vec__29062,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___29066 = mranderson048.reagent.v0v7v0.reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___29066 == null)){
} else {
var key_29067 = temp__4661__auto___29066;
(jsprops["key"] = key_29067);
}
...
var G__29068 = mranderson048.reagent.v0v7v0.reagent.impl.template.__GT_NativeWrapper.call(null);
(G__29068["name"] = c);
...
var len__4499__auto___29073 = arguments.length;
var i__4500__auto___29074 = (0);
while(true){
if((i__4500__auto___29074 < len__4499__auto___29073)){
args__4502__auto__.push((arguments[i__4500__auto___29074]));

var G__29075 = (i__4500__auto___29074 + (1));
i__4500__auto___29074 = G__29075;
continue;
} else {
}
break;
...
/** @this {Function} */
mranderson048.reagent.v0v7v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq29071){
...
break;
default:
var G__29078 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__29078;
continue;
...
var n__4376__auto___29080 = a.length;
var i_29081 = (0);
while(true){
if((i_29081 < n__4376__auto___29080)){
(a[i_29081] = mranderson048.reagent.v0v7v0.reagent.impl.template.as_element.call(null,(a[i_29081])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___29083 = a.length;
var i_29084 = (0);
while(true){
if((i_29084 < n__4376__auto___29083)){
var val_29085 = (a[i_29084]);
if(((cljs.core.vector_QMARK_.call(null,val_29085)) && ((mranderson048.reagent.v0v7v0.reagent.impl.template.key_from_vec.call(null,val_29085) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_29084] = mranderson048.reagent.v0v7v0.reagent.impl.template.as_element.call(null,val_29085));

var G__29086 = (i_29084 + (1));
i_29084 = G__29086;
continue;
} else {
}
...
var ctx = ({});
var vec__29087 = mranderson048.reagent.v0v7v0.reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return mranderson048.reagent.v0v7v0.reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__29087,(0),null);
var derefed = cljs.core.nth.call(null,vec__29087,(1),null);
...
var G__29090 = (cljs.core.count.call(null,argv) - first_child);
switch (G__29090) {
case (0):
...
break;
default:
return (mranderson048.reagent.v0v7v0.reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__29090){
...
//# sourceMappingURL=template.js.map?rel=1530661639757
