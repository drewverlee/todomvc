...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__33715){
...
var title = cljs.core.get.call(null,map__33716__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.call(null,map__33716__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.call(null,map__33716__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.call(null,map__33716__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.call(null,map__33716__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = mranderson048.reagent.v0v7v0.reagent.core.atom.call(null,title);
var save = ((function (val,map__33716,map__33716__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
...
day8.re_frame_10x.view.components.autoscroll_list = (function day8$re_frame_10x$view$components$autoscroll_list(p__33720,child){
...
var class$ = cljs.core.get.call(null,map__33721__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var scroll_QMARK_ = cljs.core.get.call(null,map__33721__$1,new cljs.core.Keyword(null,"scroll?","scroll?",-1393045951));
...
return mranderson048.reagent.v0v7v0.reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"autoscroll-list",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (node,should_scroll,map__33721,map__33721__$1,class$,scroll_QMARK_){
return (function (_){
...
});})(node,should_scroll,map__33721,map__33721__$1,class$,scroll_QMARK_))
,new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),((function (node,should_scroll,map__33721,map__33721__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (node,should_scroll,map__33721,map__33721__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (node,should_scroll,map__33721,map__33721__$1,class$,scroll_QMARK_){
return (function (p__33723,child__$1){
...
var class$__$1 = cljs.core.get.call(null,map__33724__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),class$__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),((function (map__33724,map__33724__$1,class$__$1,node,should_scroll,map__33721,map__33721__$1,class$,scroll_QMARK_){
return (function (dom_node){
return cljs.core.reset_BANG_.call(null,node,dom_node);
});})(map__33724,map__33724__$1,class$__$1,node,should_scroll,map__33721,map__33721__$1,class$,scroll_QMARK_))
], null),child__$1], null);
});})(node,should_scroll,map__33721,map__33721__$1,class$,scroll_QMARK_))
], null));
});
...
return cljs.core.reduce.call(null,(function (acc,p__33727){
var vec__33728 = p__33727;
var property = cljs.core.nth.call(null,vec__33728,(0),null);
var value = cljs.core.nth.call(null,vec__33728,(1),null);
return cljs.core.assoc.call(null,acc,cljs.core.keyword.call(null,property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p1__33726_SHARP_){
...
var len__4499__auto___33733 = arguments.length;
var i__4500__auto___33734 = (0);
while(true){
if((i__4500__auto___33734 < len__4499__auto___33733)){
args__4502__auto__.push((arguments[i__4500__auto___33734]));

var G__33735 = (i__4500__auto___33734 + (1));
i__4500__auto___33734 = G__33735;
continue;
} else {
}
break;
...
var previous_config__33704__auto__ = devtools.prefs.get_prefs.call(null);
var prefs__33705__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_.call(null,prefs__33705__auto__);

return cljs.core.apply.call(null,api_fn,args);
}finally {if(cljs.core._EQ_.call(null,devtools.prefs.get_prefs.call(null),prefs__33705__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__33705__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_.call(null,previous_config__33704__auto__);
}});

day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1);

/** @this {Function} */
day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq33731){
var G__33732 = cljs.core.first.call(null,seq33731);
var seq33731__$1 = cljs.core.next.call(null,seq33731);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33732,seq33731__$1);
});
...
var args__4502__auto__ = [];
var len__4499__auto___33737 = arguments.length;
var i__4500__auto___33738 = (0);
while(true){
if((i__4500__auto___33738 < len__4499__auto___33737)){
args__4502__auto__.push((arguments[i__4500__auto___33738]));

var G__33739 = (i__4500__auto___33738 + (1));
i__4500__auto___33738 = G__33739;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq33736){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33736));
});
...
var args__4502__auto__ = [];
var len__4499__auto___33741 = arguments.length;
var i__4500__auto___33742 = (0);
while(true){
if((i__4500__auto___33742 < len__4499__auto___33741)){
args__4502__auto__.push((arguments[i__4500__auto___33742]));

var G__33743 = (i__4500__auto___33742 + (1));
i__4500__auto___33742 = G__33743;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq33740){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33740));
});
...
var args__4502__auto__ = [];
var len__4499__auto___33745 = arguments.length;
var i__4500__auto___33746 = (0);
while(true){
if((i__4500__auto___33746 < len__4499__auto___33745)){
args__4502__auto__.push((arguments[i__4500__auto___33746]));

var G__33747 = (i__4500__auto___33746 + (1));
i__4500__auto___33746 = G__33747;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq33744){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq33744));
});
...
var tag_name = first__33750;
var first__33750__$1 = cljs.core.first.call(null,seq__33749__$1);
var seq__33749__$2 = cljs.core.next.call(null,seq__33749__$1);
var attributes = first__33750__$1;
var children = seq__33749__$2;
...
var args__4502__auto__ = [];
var len__4499__auto___33758 = arguments.length;
var i__4500__auto___33759 = (0);
while(true){
if((i__4500__auto___33759 < len__4499__auto___33758)){
args__4502__auto__.push((arguments[i__4500__auto___33759]));

var G__33760 = (i__4500__auto___33759 + (1));
i__4500__auto___33759 = G__33760;
continue;
} else {
}
break;
...
day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__33754){
var vec__33755 = p__33754;
var class$ = cljs.core.nth.call(null,vec__33755,(0),null);
var expanded_QMARK_ = mranderson048.reagent.v0v7v0.reagent.core.atom.call(null,true);
return ((function (expanded_QMARK_,vec__33755,class$){
return (function (data__$1){
...
;})(expanded_QMARK_,vec__33755,class$))
});

day8.re_frame_10x.view.components.simple_render.cljs$lang$maxFixedArity = (2);

/** @this {Function} */
day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq33751){
var G__33752 = cljs.core.first.call(null,seq33751);
var seq33751__$1 = cljs.core.next.call(null,seq33751);
var G__33753 = cljs.core.first.call(null,seq33751__$1);
var seq33751__$2 = cljs.core.next.call(null,seq33751__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33752,G__33753,seq33751__$2);
});
...
//# sourceMappingURL=components.js.map?rel=1530661650367
