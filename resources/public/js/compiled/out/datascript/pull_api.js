...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__22225 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__22225,kvps);
} else {
return G__22225;
}
})());
...
var depth = cljs.core.get.call(null,map__22226__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__22226__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__22228 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__22228__$1 = (((G__22228 == null))?null:cljs.core.persistent_BANG_.call(null,G__22228));
if((G__22228__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__22228__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__22229){
var vec__22230 = p__22229;
var seq__22231 = cljs.core.seq.call(null,vec__22230);
var first__22232 = cljs.core.first.call(null,seq__22231);
var seq__22231__$1 = cljs.core.next.call(null,seq__22231);
var frame = first__22232;
var frames = seq__22231__$1;
...
var or__3922__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__22233 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__22233,kvps);
} else {
return G__22233;
}
})();
...
var map__22234 = parent;
var map__22234__$1 = ((((!((map__22234 == null)))?(((((map__22234.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22234.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22234):map__22234);
var recursion = cljs.core.get.call(null,map__22234__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__22234__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_22236 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_22236){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_22236,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_22236))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__22238){
...
var parent = first__22241;
var frames = seq__22240__$1;
var limit = cljs.core.get.call(null,opts,new cljs.core.Keyword(null,"limit","limit",-1355822363),(1000));
var found = cljs.core.not_empty.call(null,(function (){var G__22242 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__22242);
} else {
return G__22242;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__22239,seq__22240,first__22241,seq__22240__$1,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__22239,seq__22240,first__22241,seq__22240__$1,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__22239,seq__22240,first__22241,seq__22240__$1,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__22239,seq__22240,first__22241,seq__22240__$1,parent,frames))
);
...
if(cljs.core.truth_((function (){var and__3911__auto__ = component_QMARK_;
...
var as_value = (function (){var G__22243 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__22243,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__22239,seq__22240,first__22241,seq__22240__$1,parent,frames){
return (function (p1__22237_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__22237_SHARP_]);
});})(G__22243,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__22239,seq__22240,first__22241,seq__22240__$1,parent,frames))
,G__22243);
} else {
return G__22243;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__22244 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__22244);
} else {
return G__22244;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__22245 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__22245,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__22245;
}
})());
...
var vec__22246 = spec;
var attr_key = cljs.core.nth.call(null,vec__22246,(0),null);
var opts = cljs.core.nth.call(null,vec__22246,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__22249){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__22253){
...
var frame = first__22256;
var frames = seq__22255__$1;
return datascript.pull_api.expand_result.call(null,frames,datascript.pull_api.into_BANG_.call(null,new cljs.core.Keyword(null,"expand-kvps","expand-kvps",44141154).cljs$core$IFn$_invoke$arity$1(frame),(function (){var or__3922__auto__ = datascript.pull_api.single_frame_result.call(null,new cljs.core.Keyword("datascript.pull-api","expand-rev","datascript.pull-api/expand-rev",2143627459),frame);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__22257){
var vec__22258 = p__22257;
var seq__22259 = cljs.core.seq.call(null,vec__22258);
var first__22260 = cljs.core.first.call(null,seq__22259);
var seq__22259__$1 = cljs.core.next.call(null,seq__22259);
var frame = first__22260;
var frames = seq__22259__$1;
...
var vec__22261 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__22261,(0),null);
var datoms = cljs.core.nth.call(null,vec__22261,(1),null);
...
var attr = cljs.core.get.call(null,map__22264__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__22264__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__22266 = recursion;
if(!((attr == null))){
return datascript.pull_api.push_recursion.call(null,G__22266,attr,eid);
} else {
return G__22266;
}
})();
...
var map__22267 = frame;
var map__22267__$1 = ((((!((map__22267 == null)))?(((((map__22267.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22267.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22267):map__22267);
var eid = cljs.core.get.call(null,map__22267__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__22267__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__3922__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__22269){
while(true){
...
var frame = first__22272;
var frames = seq__22271__$1;
var temp__4655__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__4655__auto__){
var eids = temp__4655__auto__;
...
var G__22273 = db;
var G__22274 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__22273;
p__22269 = G__22274;
continue;
}
...
while(true){
var G__22275 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames));
var G__22275__$1 = (((G__22275 instanceof cljs.core.Keyword))?G__22275.fqn:null);
switch (G__22275__$1) {
case "expand":
var G__22282 = db;
var G__22283 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__22282;
frames = G__22283;
continue;
...
case "expand-rev":
var G__22284 = db;
var G__22285 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__22284;
frames = G__22285;
continue;
...
case "pattern":
var G__22286 = db;
var G__22287 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__22286;
frames = G__22287;
continue;
...
case "recursion":
var G__22288 = db;
var G__22289 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__22288;
frames = G__22289;
continue;
...
var f = first__22278;
var remaining = seq__22277__$1;
var result = (function (){var G__22279 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__22279);
} else {
return G__22279;
}
})();
...
var G__22290 = db;
var G__22291 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__22280 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__22280,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__22280;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22275__$1)].join('')));
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__22292_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__22292_SHARP_);
})),eids);
...
//# sourceMappingURL=pull_api.js.map?rel=1530661626540
