...
var G__27016 = devtools.prefs.pref.call(null,v);
v = G__27016;
continue;
} else {
return v;
...
}catch (e27019){var _e__26065__auto__ = e27019;
return false;
}})();
...
}catch (e27023){var _e__26065__auto__ = e27023;
return false;
}})();
...
}catch (e27025){var _e__26065__auto__ = e27025;
return false;
}}
}
});
...
var vec__27027 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__27027,(0),null);
var name = cljs.core.nth.call(null,vec__27027,(1),null);
...
return cljs.core.some.call(null,(function (p1__27030_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27030_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1530661635461
