...
var o26914 = temp__4655__auto__;
var temp__4655__auto____$1 = (o26914["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o26915 = temp__4655__auto____$1;
return (o26915["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26058__auto__ = f;
return (o__26058__auto__["toString"]).call(o__26058__auto__);
} else {
return "";
}
}catch (e26916){var _ = e26916;
return "";
}});
...
try{var o__26058__auto___26918 = t;
(o__26058__auto___26918["cljs$lang$ctorPrWriter"]).call(o__26058__auto___26918,t,writer);
}catch (e26917){var __26919 = e26917;
}
...
var char_code = (function (){var o__26058__auto__ = (new String(char$));
return (o__26058__auto__["charCodeAt"]).call(o__26058__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26058__auto__ = String;
return (o__26058__auto__["fromCharCode"]).call(o__26058__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26920 = num_code;
switch (G__26920) {
case (1):
return (185);
...
var o__26058__auto__ = String;
return (o__26058__auto__["fromCharCode"]).call(o__26058__auto__,superscript_code);
});
/**
...
}catch (e26922){var _e__26065__auto__ = e26922;
return false;
}})())){
...
var vec__26923 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26923,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o26926 = temp__4655__auto__;
var temp__4655__auto____$1 = (o26926["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o26927 = temp__4655__auto____$1;
return (o26927["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26930){
var vec__26931 = p__26930;
var ns_detector = cljs.core.nth.call(null,vec__26931,(0),null);
...
var G__26937 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26938 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26937;
remaining_tokens = G__26938;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26928){
var G__26929 = cljs.core.first.call(null,seq26928);
var seq26928__$1 = cljs.core.next.call(null,seq26928);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26929,seq26928__$1);
});
...
var vec__26942 = cljs.core.split_with.call(null,(function (p1__26941_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26941_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26942,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26942,(1),null);
...
var vec__26945 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26945,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26945,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26948 = cljs.core.rest.call(null,remaining_tokens);
var G__26949 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26948;
name_tokens = G__26949;
continue;
} else {
...
var vec__26952 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26952,(0),null);
var arity = cljs.core.nth.call(null,vec__26952,(1),null);
var vec__26955 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26955,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26955,(1),null);
var vec__26958 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26958,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26958,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26958,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26958,(3),null);
...
var vec__26964 = result;
var munged_ns = cljs.core.nth.call(null,vec__26964,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26964,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26964,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26964,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26964,(4),null);
var arity = cljs.core.nth.call(null,vec__26964,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__26968 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__26968,(0),null);
var args = cljs.core.nth.call(null,vec__26968,(1),null);
var vec__26971 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26971,(0),null);
var name = cljs.core.nth.call(null,vec__26971,(1),null);
...
var G__26974 = (arity + (1));
var G__26975 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26976){
var vec__26977 = p__26976;
var arity = cljs.core.nth.call(null,vec__26977,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26977,(1),null);
...
return cljs.core.get.call(null,arities,p1__26980_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26981_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26984){
var vec__26985 = p__26984;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26985,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26982){
var G__26983 = cljs.core.first.call(null,seq26982);
var seq26982__$1 = cljs.core.next.call(null,seq26982);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26983,seq26982__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26993__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26993__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26993__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26993__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26994 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26994,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26994,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26994,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26994,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26994,(4),null);
var arity = cljs.core.nth.call(null,vec__26994,(5),null);
...
var o__26058__auto__ = f;
return (o__26058__auto__["getBasis"]).call(o__26058__auto__);
});
/**
...
}catch (e26998){var _e__26065__auto__ = e26998;
...
var G__26999 = (obj[cljs.core.first.call(null,path)]);
var G__27000 = cljs.core.rest.call(null,path);
obj = G__26999;
path = G__27000;
continue;
} else {
...
return (function (accum,p__27001){
var vec__27002 = p__27001;
var bit = cljs.core.nth.call(null,vec__27002,(0),null);
var protocol = cljs.core.nth.call(null,vec__27002,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27005){
var vec__27006 = p__27005;
var ns = cljs.core.nth.call(null,vec__27006,(0),null);
var name = cljs.core.nth.call(null,vec__27006,(1),null);
var selector = cljs.core.nth.call(null,vec__27006,(2),null);
...
return (function (p__27010){
var vec__27011 = p__27010;
var munged_name = cljs.core.nth.call(null,vec__27011,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27011,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27011,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27009_SHARP_){
return (obj[cljs.core.first.call(null,p1__27009_SHARP_)]);
});})(name,sorted_matches,vec__27011,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1530661635367
