...
var line = cljs.core.get.call(null,map__34494__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__34494__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e34493){var _e = e34493;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___34496 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___34496)){
var seen_errors_34497 = temp__4655__auto___34496;
if(cljs.core.truth_(seen_errors_34497.has(self))){
} else {
seen_errors_34497.add(self);

var temp__4657__auto___34498 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___34498)){
var sense_34499 = temp__4657__auto___34498;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_34499)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1530661653036
