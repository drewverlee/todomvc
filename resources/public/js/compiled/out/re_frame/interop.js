...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__25051 = cljs.core.instance_QMARK_;
var expr__25052 = reactive_val;
if(cljs.core.truth_(pred__25051.call(null,reagent.ratom.RAtom,expr__25052))){
return "ra";
} else {
if(cljs.core.truth_(pred__25051.call(null,reagent.ratom.RCursor,expr__25052))){
return "rc";
} else {
if(cljs.core.truth_(pred__25051.call(null,reagent.ratom.Reaction,expr__25052))){
return "rx";
} else {
if(cljs.core.truth_(pred__25051.call(null,reagent.ratom.Track,expr__25052))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1530661631518
