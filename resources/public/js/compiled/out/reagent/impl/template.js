...
var G__21029 = o;
(G__21029[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__21030__delegate = function (args){
...
while (G__21031__i < G__21031__a.length) {G__21031__a[G__21031__i] = arguments[G__21031__i + 0]; ++G__21031__i;}
  args = new cljs.core.IndexedSeq(G__21031__a,0,null);
} 
return G__21030__delegate.call(this,args);};
G__21030.cljs$lang$maxFixedArity = 0;
G__21030.cljs$lang$applyTo = (function (arglist__21032){
var args = cljs.core.seq(arglist__21032);
return G__21030__delegate(args);
});
...
var G__21033 = o;
(G__21033[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__21034__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__21035__i < G__21035__a.length) {G__21035__a[G__21035__i] = arguments[G__21035__i + 0]; ++G__21035__i;}
  args = new cljs.core.IndexedSeq(G__21035__a,0,null);
} 
return G__21034__delegate.call(this,args);};
G__21034.cljs$lang$maxFixedArity = 0;
G__21034.cljs$lang$applyTo = (function (arglist__21036){
var args = cljs.core.seq(arglist__21036);
return G__21034__delegate(args);
});
...
var G__21038 = props;
var G__21038__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21038,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21038);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21038__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__21039){
...
var props = map__21040__$1;
var class$ = cljs.core.get.call(null,map__21040__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__21040,map__21040__$1,props,class$){
return (function (c){
...
});})(map__21040,map__21040__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__21042){
...
var on_write = cljs.core.get.call(null,map__21043__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__21043,map__21043__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__21043,map__21043__$1,on_write))
);
} else {
...
var G__21046 = jsprops;
(G__21046["defaultValue"] = value);

(G__21046["onChange"] = ((function (G__21046,v,value,on_change){
return (function (p1__21045_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21045_SHARP_);
});})(G__21046,v,value,on_change))
);
...
var vec__21049 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21049,(0),null);
var id = cljs.core.nth.call(null,vec__21049,(1),null);
var class$ = cljs.core.nth.call(null,vec__21049,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___21053 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___21053 == null)){
} else {
var key_21054 = temp__4661__auto___21053;
(jsprops["key"] = key_21054);
}
...
var temp__4661__auto___21055 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__4661__auto___21055 == null)){
} else {
var key_21056 = temp__4661__auto___21055;
reagent.impl.template.oset.call(null,jsprops,"key",key_21056);
}
...
var G__21057 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__21057["name"] = c);
...
var len__4499__auto___21062 = arguments.length;
var i__4500__auto___21063 = (0);
while(true){
if((i__4500__auto___21063 < len__4499__auto___21062)){
args__4502__auto__.push((arguments[i__4500__auto___21063]));

var G__21064 = (i__4500__auto___21063 + (1));
i__4500__auto___21063 = G__21064;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21060){
var G__21061 = cljs.core.first.call(null,seq21060);
var seq21060__$1 = cljs.core.next.call(null,seq21060);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21061,seq21060__$1);
});
...
break;
default:
var G__21067 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__21067;
continue;
...
var n__4376__auto___21069 = a.length;
var i_21070 = (0);
while(true){
if((i_21070 < n__4376__auto___21069)){
(a[i_21070] = reagent.impl.template.as_element.call(null,(a[i_21070])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___21072 = a.length;
var i_21073 = (0);
while(true){
if((i_21073 < n__4376__auto___21072)){
var val_21074 = (a[i_21073]);
if(((cljs.core.vector_QMARK_.call(null,val_21074)) && ((reagent.impl.template.key_from_vec.call(null,val_21074) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_21073] = reagent.impl.template.as_element.call(null,val_21074));

var G__21075 = (i_21073 + (1));
i_21073 = G__21075;
continue;
} else {
}
...
var ctx = ({});
var vec__21076 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21076,(0),null);
var derefed = cljs.core.nth.call(null,vec__21076,(1),null);
...
var G__21079 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21079) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__21079){
...
//# sourceMappingURL=template.js.map?rel=1530661622612
